...
namespace Menu_Selection
{
    ...
    {
        public Breakfast(Dictionary<int, int> items)
        {
            ...
            // Add water if no coffee is ordered
            ...
            // Breakfast can only have 1 side and 1 main dish
            if (totalMain == 0)
            {
            ...
            if (totalMain > 1)
            {
                errors.Add("eggs cannot be ordered more than once");
                validOrder = false;
            }
            if (totalSide == 0)
            {
            ...
            if (totalSide > 1)
            {
                errors.Add("toast cannot be ordered more than once");
                validOrder = false;
            }
        ...
        // Desserts cannot be ordered for Breakfast
